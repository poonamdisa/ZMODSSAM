...
export class BusinessPartnerWrapper {
    ...
    constructor(entity) {
        ...
        }// MOD customisation added to defualt the partner type for PE
        else
        {
            this.partnerType='PE';
        }
    ...
    communicationsPropertyMap() {
        switch (this.partnerType) {
            ...
            case 'PE': //For Employee, the Employee_Nav EntitySet
                Logger.error("Comm Prop map for PE");
                return {
    ...
    nameEntity() {
        switch (this.partnerType) {
            ...
            case 'PE': //For Employee, the Employee_Nav EntitySet
            //MOD customisation to return Z entity
                return this.entity.ZEmployee_Nav;
            case 'S4': 
                try {
    ...
    communicationSet() {
        switch (this.partnerType) {
            ...
            case 'PE': //For Employee, the Employee_Nav EntitySet
                //return []; MOD customisation to return Z entity for PE
                 return this.entity.ZEmployee_Nav.EmployeeCommunications_Nav;
            case 'S4':
                try {
