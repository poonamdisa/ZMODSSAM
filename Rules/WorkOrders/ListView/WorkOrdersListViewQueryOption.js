...
export default function WorkOrdersListViewQueryOption(context) {
    ...
    //MoD customisation to enable search on FL since it is added on the list screen
    if (searchString) {
        ...
        //filters.push(`substringof('${searchString}', tolower(HeaderFunctionLocation))`);
        filters.push(`substringof('${searchString}', tolower(FunctionalLocation/FuncLocDesc))`);
