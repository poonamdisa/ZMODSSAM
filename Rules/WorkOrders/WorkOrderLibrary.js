...
export class WorkOrderLibrary {
    ...
    */
     ...
     */
    //MoD customisation to add Equipment and FL
    static getWorkOrdersListViewQueryOptions(context) {
        let queryBuilder = context.dataQueryBuilder();
        queryBuilder.select('*,OrderMobileStatus_Nav/*,WODocuments/DocumentID,WOPartners/Employee_Nav/EmployeeName,WOPartners/PartnerFunction,MarkedJob/PreferenceValue,WOPriority/PriorityDescription,WOPriority/Priority,Equipment/EquipId, Equipment/EquipDesc,FunctionalLocation/FuncLocDesc, FunctionalLocation/FuncLocId');
        queryBuilder.expand('WODocuments,WODocuments/Document,OrderMobileStatus_Nav/OverallStatusCfg_Nav,Operations,Operations/SubOperations,WOPriority,MarkedJob,UserTimeEntry_Nav,WOPartners,WOPartners/Employee_Nav,FunctionalLocation,Equipment');
